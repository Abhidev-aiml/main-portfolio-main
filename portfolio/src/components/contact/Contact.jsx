...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_7hkn0zb', 'template_erkel1l', form.current, {
        publicKey: 'OqdCWpsOZHqrgjQR2',
      })
      e.target.reset()
  };
  return (
    ...
    <div className="contact__content">
        ...
        <div className="contact__info">
            ...
            <UilEnvelopeCheck size="20" color="#000000" className="contact__card-icon" />
            ...
            <div className="contact__card">
            <UilWhatsapp size="20" color="#000000" className="contact__card-icon" />
            ...
            <div className="contact__card">
            <UilInstagram size="20" color="#000000" className="contact__card-icon" />
