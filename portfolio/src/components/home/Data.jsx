...
<div className="home__data">
    <h1 className="home__title">Abhi Yadav
    <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
    ...
    <p className="home__description">I'm a creative full stack developer based in India, and I'm very passionate about my work.</p>
